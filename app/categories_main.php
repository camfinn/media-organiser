  ...
  <div class="card-body">
    ...
    <div class="col-3">
      ...
      <?php
          ...
          echo "<a class=\"nav-link $status\" id=\"v-".$search_category['id']."-tab\" data-toggle=\"pill\" href=\"#v-".$search_category['id']."\" role=\"tab\" aria-controls=\"v-".$search_category['id']."\" aria-selected=\"false\">".$search_category['title']."</a>";
